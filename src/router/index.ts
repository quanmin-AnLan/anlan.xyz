...
const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/jubao/view/20220509',
        component: () => import('../views/ju-bao/children/20220509.vue'),
      },
      {
        path: '/jubao/view/20220516',
        component: () => import('../views/ju-bao/children/20220516.vue'),
      },
      {
        path: '/jubao/view/20220523',
        component: () => import('../views/ju-bao/children/20220523.vue'),
      },
      {
        path: '/jubao/view/20220530',
        component: () => import('../views/ju-bao/children/20220530.vue'),
      },
      {
        path: '/jubao/view/20220608',
        component: () => import('../views/ju-bao/children/20220608.vue'),
      },
      {
        path: '/jubao/view/20220613',
        component: () => import('../views/ju-bao/children/20220613.vue'),
      },
      {
        path: '/jubao/view/20220620',
        component: () => import('../views/ju-bao/children/20220620.vue'),
      },
      {
        path: '/jubao/view/20220627',
        component: () => import('../views/ju-bao/children/20220627.vue'),
      },
      {
        path: '/jubao/view/20220704',
        component: () => import('../views/ju-bao/children/20220704.vue'),
      },
      {
        path: '/jubao/view/20220711',
        component: () => import('../views/ju-bao/children/20220711.vue'),
      },
      {
        path: '/jubao/view/20220718',
        component: () => import('../views/ju-bao/children/20220718.vue'),
      },
      {
        path: '/jubao/view/20220725',
        component: () => import('../views/ju-bao/children/20220725.vue'),
      },
    ],
  },
  // {
